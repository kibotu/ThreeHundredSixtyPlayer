...
import com.exozet.threehundredsixty.player.SslUtils.getSslContextForCertificateFile
import com.exozet.threehundredsixty.player.SslUtils.getTrustAllHostsSSLSocketFactory
...
internal object RequestProvider {
    ...
    private val authToken = "6320447e-3e22-4d4c-b29a-89216cd82e4f"
    ...
    private fun createService(uri: Uri): ExozetService {
        return Retrofit.Builder()
                ...
                .client(createOkHttpClient(hashMapOf(
